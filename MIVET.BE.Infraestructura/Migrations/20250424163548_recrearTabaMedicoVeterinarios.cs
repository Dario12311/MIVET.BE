...
{
    /// <inheritdoc />
    public partial class recrearTabaMedicoVeterinarios : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Crear la tabla con las columnas y restricciones solicitadas
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"), // Autoincrementado
                    NumeroDocumento = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false), // Clave primaria
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicoVeterinario", x => x.NumeroDocumento); // Clave primaria
                    table.UniqueConstraint("AK_MedicoVeterinario_ID", x => x.ID); // ID único
                    table.ForeignKey(
